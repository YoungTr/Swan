...
import com.bomber.swan.resource.matrix.SwanResource.config
...
//                apply { this.eventListeners = eventListeners }
            ...
            /** @see [SwanResource.Config.useExperimentalLeakFinders] */
...
//                eventListeners = eventListeners,
     ...
     * ```
     *
     * In Java, use [SwanResource.Config.Builder] instead:
     * ```java
     * LeakCanary.Config config = LeakCanary.getConfig().newBuilder()
     *    .retainedVisibleThreshold(3)
     *    .build();
