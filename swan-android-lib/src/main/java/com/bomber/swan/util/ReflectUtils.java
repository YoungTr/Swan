...
public class ReflectUtils {
    private final static String TAG = "Swan.ReflectUtils";
    ...
    public static <T> T reflectObject(Object instance, String name, T defaultValue, boolean isHard) {
        ...
        if (isHard) {
            try {
                ...
                SwanLog.e(TAG, e.toString() + "isHard=%s\n%s", true, StackUtilKt.printException(e));
            }
        } else {
            try {
                ...
                SwanLog.e(TAG, e.toString() + "isHard=%s\n%s", false, StackUtilKt.printException(e));
            }
        }
        return defaultValue;
    }
